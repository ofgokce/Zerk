...
/// One `@InjectableAlias` or `#InjectableAlias` declaration, as collected from source.
///
...
/// representative. A `#InjectableAlias` list has no such structure; its members are
/// peers.
struct AliasDeclaration {
    ...
    /// side. `nil` for `#InjectableAlias`, whose entries are all peers.
    let aliasKey: String?
